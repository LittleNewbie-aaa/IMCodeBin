...
public class TagFlowLayout extends FlowLayout implements TagAdapter.OnDataChangedListener {
     ...
     * 设置是否显示输入框，默认显示
     *
     * @param attachInput 是否显示输入框
     */
    public void setAttachInput(boolean attachInput) {
    ...
    private void removeItem(int position) {
        if (removeListener != null) {
            removeListener.roomItem(mTagAdapter.getItem(mAttachLabel ? position - 1 : position));
        }
