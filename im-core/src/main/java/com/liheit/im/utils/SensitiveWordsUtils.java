...
public class SensitiveWordsUtils {
    ...
    public static Set<String> sensitiveWordMap2;
    ...
    public static synchronized void init(Set<String> sensitiveWordSet) {
        sensitiveWordMap2=sensitiveWordSet;
    ...
    public static String findText(String txt) {
        if(sensitiveWordMap2!=null&&sensitiveWordMap2.size()>0){
            for (String str : sensitiveWordMap2) {
                if(txt.contains(str)){
                    return str;
                }
            }
